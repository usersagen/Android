...
public class PythonFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        pythonViewModel = new ViewModelProvider(this).get(PythonViewModel.class);
